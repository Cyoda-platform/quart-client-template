...
from application.routes.activity_reports import activity_reports_bp
...
QuartSchema(
    ...
    tags=[
        ...
        {"name": "OtherEntities", "description": "OtherEntity management endpoints"},
        {
            ...
            "description": "ActivityReport management endpoints",
        },
...
# Register blueprints
app.register_blueprint(activity_reports_bp)
