...
from application.routes.claim_documents import claim_documents_bp
from application.routes.claims import claims_bp
from application.routes.fraud_alerts import fraud_alerts_bp
from application.routes.policies import policies_bp
from application.routes.queues import queues_bp
