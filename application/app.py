...
QuartSchema(
    ...
    tags=[
        {
            "name": "instruments",
            "description": "Instrument management endpoints",
        },
        ...
        {"name": "risk-profiles", "description": "Risk profile management endpoints"},
        {"name": "ledger-entries", "description": "Ledger entry management endpoints"},
...
app.register_blueprint(ledger_entries_bp)
