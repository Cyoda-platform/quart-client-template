...
class CreditReport(CyodaEntity):
    ...
    bureau_name: str = Field(..., description="Credit bureau name (EQUIFAX, EXPERIAN, TRANSUNION)")
    ...
    credit_utilization_percent: float = Field(default=0.0, description="Credit utilization percentage")
    ...
    public_records: int = Field(default=0, description="Number of public records (bankruptcies, liens)")
    inquiries_last_6_months: int = Field(default=0, description="Hard inquiries in last 6 months")
    
    average_account_age_months: int = Field(default=0, description="Average age of accounts in months")
    oldest_account_months: int = Field(default=0, description="Age of oldest account in months")
