...
class Instrument(CyodaEntity):
    ...
    instrument_id: str = Field(..., description="Business identifier for the instrument")
    symbol: str = Field(..., description="Trading symbol")
    type: str = Field(..., description="Instrument type: STOCK, FUTURE, OPTION, etc.")
    expiry_date: Optional[str] = Field(None, description="Expiry date for derivatives (ISO 8601)")
