...
class LimitRule(CyodaEntity):
    ...
    instrument_id: Optional[str] = Field(None, description="Specific instrument (null for all)")
    limit_type: str = Field(..., description="Type of limit: NOTIONAL, QUANTITY, LOSS, etc.")
