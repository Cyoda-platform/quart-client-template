...
class Portfolio(CyodaEntity):
    ...
    sector_allocation: Optional[Dict[str, float]] = Field(None, description="Sector allocation")
    ...
    def update_metrics(self, total_value: float, unrealized_pnl: float, realized_pnl: float) -> None:
