...
class CustomerQueryParams(BaseModel):
    ...
    sort_by: Optional[str] = Field(default="created_at", description="Sort field: name, email, created_at")
...
class CustomerResponse(BaseModel):
    ...
    address: Optional[Dict[str, Any]] = Field(default=None, description="Customer address")
...
class ValidationErrorResponse(BaseModel):
    ...
    field_errors: Optional[Dict[str, List[str]]] = Field(default=None, description="Field-specific errors")
