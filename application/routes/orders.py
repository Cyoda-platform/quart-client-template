"""
Order Routes for Cyoda Trading Platform

Manages all Order-related API endpoints including CRUD operations
for trading orders with lifecycle management.
"""
...
from ..entity.order import Order  # noqa: F401
...
async def update_order(entity_id: str) -> ResponseReturnValue:
