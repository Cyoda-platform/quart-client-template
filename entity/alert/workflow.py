...
async def process_evaluate_alerts(entity):
    # TODO: Implement actual alert condition evaluation logic here
    # For prototype, just mark alerts_triggered empty or mock triggered alerts
    entity['alerts_triggered'] = []