...
# Use asyncio.Lock to avoid race conditions
...
# Track ingestion jobs — job_id to status info
...
async def fetch_external_crocodiles() -> List[Dict[str, Any]]:
    async with httpx.AsyncClient() as client:
        try:
            ...
            data = resp.json()
            # The API returns a JSON object with a "data" key containing a list of crocodiles
            # TODO: If API response structure changes, update accordingly
