...
@validate_request(PetFetchRequest)  # workaround: validate_request must come after route for POST due to quart-schema defect
...
@validate_request(OrderCreateRequest)  # workaround: validate_request must come after route for POST due to quart-schema defect
