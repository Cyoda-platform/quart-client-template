...
async def add_book():
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            external_response = await client.post(f"{FAKER_API_URL}/Books", json=data)
...
async def update_book(book_id):
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            external_response = await client.post(f"{FAKER_API_URL}/Books/{book_id}", json=data)
        ...
        book.update({
            ...
            "authorId": data.get("authorId", book["authorId"])
        })
...
async def add_author():
    ...
    try:
        async with httpx.AsyncClient() as client:
            external_response = await client.post(f"{FAKER_API_URL}/Authors", json=data)
            external_response.raise_for_status()
...
async def update_author(author_id):
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            external_response = await client.post(f"{FAKER_API_URL}/Authors/{author_id}", json=data)
            external_response.raise_for_status()
            external_author = external_response.json()
...
async def add_user():
    ...
    try:
        async with httpx.AsyncClient() as client:
            external_response = await client.post(f"{FAKER_API_URL}/Users", json=data)
            external_response.raise_for_status()
...
async def update_user(user_id):
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            external_response = await client.post(f"{FAKER_API_URL}/Users/{user_id}", json=data)
            external_response.raise_for_status()
            external_user = external_response.json()
...
async def add_task():
    ...
    try:
        async with httpx.AsyncClient() as client:
            external_response = await client.post(f"{FAKER_API_URL}/Tasks", json=data)
            external_response.raise_for_status()
...
async def update_task(task_id):
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            external_response = await client.post(f"{FAKER_API_URL}/Tasks/{task_id}", json=data)
            external_response.raise_for_status()
            external_task = external_response.json()
...
async def authentication():
    ...
    try:
        async with httpx.AsyncClient() as client:
            external_response = await client.post(f"{FAKER_API_URL}/Authentication", json=data)
            external_response.raise_for_status()
