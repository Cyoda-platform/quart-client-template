...
async def process_entity(job_id, data):
    ...
    # Mark job as completed in the external service (if applicable)
...
async def process():
    ...
    try:
        ...
        await entity_service.add_item(token=cyoda_token, entity_model="entity_name", entity_version=ENTITY_VERSION, entity=entity)
