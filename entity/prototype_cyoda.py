...
async def search_pets_by_status():
    ...
    # Instead of above (template), build actual condition to match any status in list
    # Since INOT_CONTAINS with "" is nonsense, change to IN with list of status strings
